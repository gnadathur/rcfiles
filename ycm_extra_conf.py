...
'-isystem',
'/scratch/code/kmdk_headers/opt/vmware',
'-isystem',
'/scratch/code/wsbld/apex/include/internal',
'-isystem',
'/scratch/code/wsbld/apex/include/public',
'-isystem',
'/scratch/code/wsbld/ycm',
'-I',
'/scratch/code/wsbld/ycm',
]
...
def AddDirsRecursively( flagsRec ):
    global flags
    new_flags = []
    for root, dirs, files in os.walk(flagsRec):
        for d in dirs:
            if d == ".git":
                continue
            new_flags.append('-I')
            new_flags.append(os.path.join(root, d))
    flags += new_flags
